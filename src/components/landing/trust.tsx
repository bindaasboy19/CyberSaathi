    ...
    <div id="trust-center" className="py-24 border-t border-white/[0.04] relative bg-slate-950/20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto px-4">
        ...
        <div className="bg-slate-900/40 border border-white/[0.06] rounded-2xl p-6 sm:p-8 space-y-4 hover:border-white/15 transition-all backdrop-blur-md">
          ...
          <p className="text-slate-400 text-xs sm:text-sm leading-relaxed font-sans">
            We follow a **Responsible Disclosure Policy**. If you detect any vulnerability or security loophole across our apps, email details securely to <strong className="text-emerald-400 font-semibold">csk1916313@gmail.com</strong>. We commit to auditing and fixing disclosures within 48 hours.
          </p>
        </div>
